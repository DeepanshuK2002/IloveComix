...
export function FollowingUsersTab() {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-400 mt-1">0 members you follow.</p>
        </div>
      ...
      {/* Empty State Container (matching Screenshot 212540) */}
      <div className="rounded-2xl border border-zinc-800/80 bg-[#16181d]/70 backdrop-blur-md p-16 text-center shadow-lg">
        ...
        <p className="text-xs text-zinc-500">
          Visit a member's profile and tap Follow.
        </p>
      </div>
    </div>
  );
